...
| Project | Status |
|---------|--------|
| TUHO Wind (72 MW, Croatia) | ✅ Parity-validated |
| Oborovo Solar (53.63 MW, Croatia) | ✅ Parity-validated |
| Generic / new projects | ⚠️ Unvalidated — review independently |
...
- Help icon (📖) → collapsible onboarding panel
