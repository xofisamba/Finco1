...
def oborovo_source_config() -> ConstructionRuntimeConfig:
    ...
    return ConstructionRuntimeConfig(
        ...
        source_cumulative_senior_validation_keur=OBOROVO_SOURCE_CUMULATIVE_SENIOR_KEUR,
        source_vat_requirement_validation_keur=OBOROVO_SOURCE_VAT_REQUIREMENT_KEUR,
        equity_available_keur=500.0,
        shl_available_keur=14_620.773895,
        senior_commitment_keur=42_852.266726,
        senior_idc_source_keur=1_086.031998,
        senior_commitment_fee_source_keur=188.562901,
        structuring_fee_source_keur=477.302687,
        vat_idc_source_keur=208.447618,
        vat_commitment_fee_source_keur=13.621953,
        final_gfa_source_keur=57_973.052657,
    )
