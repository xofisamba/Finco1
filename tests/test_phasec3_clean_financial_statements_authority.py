...
# ---------------------------------------------------------------------------
# Correction N: G2C trapped-cash UC roll-forward for BULLET-fail-closed periods
# ---------------------------------------------------------------------------

class TestCorN_G2CTrappedCash:
    """Verify Correction N.2: G2C computes a proper UC roll-forward for the
