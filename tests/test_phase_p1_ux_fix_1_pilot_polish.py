...
ALLOWED_FILES = {
    ...
    # UX-2C-1 cross-arc allowlist (Overview KPI dedup, branch-wide test footprint)
    "app/templates/partials/runtime_summary.html",  # UX-2C-1 cross-arc
    "app/ui/dashboard.py",  # UX-2C-1 cross-arc
    "tests/test_distribution_account_audit_integration.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_g1b_factory_defaults_fix.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_p1_compare_validation.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase24h2_generic_run_loop_delta_proof.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase24h3_generic_scenario_loop_compare.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase24h4_generic_export_download_pack.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase24h_closure_generic_modelling_loop_review.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase50b_scenario_state_helper_extraction.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase51c1_compare_route_golden_characterization.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase51c2_compare_route_vertical_extraction.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase51d1_validate_route_golden_characterization.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase51d2_validate_route_vertical_extraction.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase51e1_download_route_golden_characterization.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase51e2_download_route_vertical_extraction.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase57a4_single_capex_sheet_layout.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase9_closeout_gate_report.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase9_co2_cit_bridge_design.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase9_co2_revenue_bridge.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase9_cross_module_validation_pack.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase9_r99_r102_audit_gate_validation.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase9_shl_r102_runtime_wiring.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase9_sponsor_distribution_handoff_implementation.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_m1_scenario_matrix.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_m2_scenario_matrix_live.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_m3_scenario_matrix_overrides.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_m4_scenario_matrix_run.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_p1_cleanup_sprint_2_low_risk_pilot_polish.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_p1_ux_fix_1_pilot_polish.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_p2fix4_five_area_navigation.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_p2fix5b_normal_mode_shell_strip.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_p2fix5c_dashboard_kpi.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_p2fix5d_five_area_navigation.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_p2fix5e_reference_ux.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_p2fix6_c2_create_copy_ui.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_p2fix7_production_cleanup.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_pilot_blocker_1_fix.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_pr1_form_timing_fields.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_pr2_realized_gearing.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_pr3_taxonomy.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_scenario1_base_case_init.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_scenario2_fixes.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_stab1_run_refreshes_kpis.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_stab7_generic_dashboard_parity.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_stab8_e2e_runtime_validation.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_ux2_active_sheet_refresh.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_phase_ux4cde_pilot_polish.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_shl_r102_runtime_wiring_design_doc.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_sponsor_distribution_handoff_design_doc.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
    "tests/test_ux2c1_overview_kpi_deduplication.py",  # UX-2C-1 cross-arc (branch-wide test footprint)
}
