...
Conclusions:
  ...
  2. Historical/pre-construction opening LCF = ZERO.
  3. The TUHO workbook generates approximately 3,568.688 kEUR of tax loss during
     construction through SHL interest expensed in P&L with zero fiscal reintegration.
     Because the Phase 2B clean-engine boundary does not reproduce the full source
     construction interval, the construction-generated carryforward is supplied at the
     operation boundary using the generic OpeningTaxLossVintageInput transport type.
     This does not reclassify it as a historical opening loss.
    ...
    "tuho": [
        {
            ...
            # P&L: Losses N-1 (first period) = 0 / blank — no pre-construction carryforward.
            # The ~3,568.688 kEUR loss is generated in the source workbook's construction
            # interval (SHL interest through P&L, Fiscal Reintegration=0). It is NOT a
            # historical opening vintage; it is supplied at the operation boundary via
            ...
            "source_rationale": (
                ...
                "Loss is generated in the source workbook's construction interval, "
                "not a historical pre-construction opening input. "
                "Supplied at the operation boundary via construction_generated_carryforward. "
