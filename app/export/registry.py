    ...
    return ExportRegistry(
        (
            ...
            ExportArtifact(
                ...
                path="reports/phase10_runtime_binding_inventory.csv",
                notes="Helps distinguish true evidence gaps from reporting-layer binding gaps.",
            ),
            ExportArtifact(
                artifact_name="Phase 10 evidence coverage summary",
                ...
                path="reports/phase10_evidence_coverage_summary.csv",
                notes="Used by the Executive Dashboard to quantify review maturity without overstating certainty.",
            ),
            ExportArtifact(
